...
__CHEETAH_genTime__ = 1244608040.404207
__CHEETAH_genTimestamp__ = 'Tue Jun  9 21:27:20 2009'
__CHEETAH_src__ = 'admin/base.tmpl'
__CHEETAH_srcLastModified__ = 'Wed Mar 11 22:55:15 2009'
...
class base(site):
    ...
    def side(self, **KWS):
        ...
        ## CHEETAH: generated from #block side at line 3, col 1.
        trans = KWS.get("trans")
    ...
    def top(self, **KWS):
        ...
        ## CHEETAH: generated from #block top at line 6, col 1.
        trans = KWS.get("trans")
        if (not trans and not self._CHEETAH__isBuffering and not callable(self.transaction)):
            trans = self.transaction # is None unless self.awake() was called
        if not trans:
...
''')
    ...
    _mainCheetahMethod_for_base= 'writeBody'

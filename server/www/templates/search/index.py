...
__CHEETAH_genTime__ = 1244608040.560704
__CHEETAH_genTimestamp__ = 'Tue Jun  9 21:27:20 2009'
__CHEETAH_src__ = 'search/index.tmpl'
__CHEETAH_srcLastModified__ = 'Sat May  9 12:51:02 2009'
...
\t<h1><b></b><b></b><b></b><span>Search Results</span></h1>
...
\t\t    <h2><a href="''')
            ...
            write('''">''')
            _v = VFFSL(SL,"post.matched_title",True) # '$post.matched_title' on line 21, col 43
            if _v is not None: write(_filter(_v, rawExpr='$post.matched_title')) # from line 21, col 43.
            write('''</a></h2>
...
\t\t<div class="blog_preview">''')
            _v = VFFSL(SL,"post.matched_body",True) # '$post.matched_body' on line 24, col 29
            if _v is not None: write(_filter(_v, rawExpr='$post.matched_body')) # from line 24, col 29.
            write('''</div>
\t</div>
